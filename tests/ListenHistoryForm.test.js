...
async function testListenHistoryForm() {
    ...
    try {
        ...
        let listenHistoryResults = await driver.wait(until.elementLocated(By.id('listen-history-results')), 10000); // Adjust the class name based on your actual implementation
